package com.example.backendrestaurant.security;

import com.example.backendrestaurant.security.jwt.AuthEntryPointJwt;
import com.example.backendrestaurant.security.jwt.AuthTokenFilter;
import com.example.backendrestaurant.security.service.UserDetailsServiceImpl;
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth ->
                        ...
                        .requestMatchers("/commande/**").permitAll()
                         ...
                         .requestMatchers("/api/wishlist/meswishlist/**").permitAll() 
